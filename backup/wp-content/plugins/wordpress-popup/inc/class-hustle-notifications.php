...
class Hustle_Notifications {
	...
	public function add_in_hustle_notices() {
		...
		// Black Friday sale.
		if ( $this->is_free && ! self::was_notification_dismissed( 'black_friday_sale_banner' ) ) {
	 ...
	 * @see Hustle_Notifications::show_black_friday_notice()
	...
	/**
	 * Displays the notice with the 60 % OFF Black Friday offer.
	 *
	 * @since 4.3.5
	 */
	public function show_black_friday_notice() {
		...
		$time_left     = $deadline_date > $current_date
			...
			: false;
		?>
		<div id="hui-black-notice-content" class="notice hustle-dismissible-admin-notice" data-name="black_friday_sale_banner">

			<div class="sui-wrap">

				<div class="hui-black-notice-header">

					<span class="hui-black-ribbon"><?php esc_html_e( '60% OFF', 'hustle' ); ?></span>

					<h3 class="hui-black-title"><?php esc_html_e( 'Black Friday 60% OFF Hustle Pro!', 'hustle' ); ?></h3>

					<?php if ( ! empty( $time_left ) ) : ?>
						<div class="hui-black-timer-container">

							<p class="hui-black-timer-slogan"><?php esc_html_e( 'Limited Black Friday offer!', 'hustle' ); ?></p>

							<div class="hui-black-timer">

								<div class="hui-black-time">

									<p><?php esc_html_e( 'Days', 'hustle' ); ?></p>

									<?php $this->print_black_friday_countdown_number( $time_left->d ); ?>

								</div>

								<span class="hui-black-timer-dots" aria-hidden="true"></span>

								<div class="hui-black-time">

									<p><?php esc_html_e( 'Hours', 'hustle' ); ?></p>
								...
								<div class="hui-black-time">
									...
									<p><?php esc_html_e( 'Minutes', 'hustle' ); ?></p>
				...
				<div class="hui-black-notice-body">

					<div class="hui-black-notice-content">

						<p><?php esc_html_e( 'Get Hustle Pro for the lowest price you will ever see and create UNLIMITED Popups, Optins, Slide-ins, and Embeds!', 'hustle' ); ?></p>

						<p class="hui-black-notice-statement"><?php esc_html_e( '*Only admin users can see this message', 'hustle' ); ?></p>

					</div>

					<a href="https://premium.wpmudev.org/project/hustle/?coupon=BF2020HUSTLE&checkout=0&utm_source=hustle&utm_medium=plugin&utm_campaign=hustle_bf2020banner" class="sui-button sui-button-blue" target="_blank">
						<?php esc_html_e( 'Get 60% OFF Hustle Pro', 'hustle' ); ?>
					</a>

					<button class="hui-black-notice-dismiss dismiss-notice">
						<?php esc_html_e( 'Dismiss', 'hustle' ); ?>
					</button>
