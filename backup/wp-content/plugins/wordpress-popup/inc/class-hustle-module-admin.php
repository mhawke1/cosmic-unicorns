			...
			if ( $plugin === $plugin_file ) {
				...
				if ( Opt_In_Utils::_is_free() ) {
					if ( ! Opt_In_Utils::is_hustle_included_in_membership() ) {
						$url   = 'https://premium.wpmudev.org/project/hustle/?coupon=BF2020HUSTLE&checkout=0&utm_source=hustle&utm_medium=plugin&utm_campaign=hustle_pluginlist_upgrade';
						$label = __( 'Upgrade *60% OFF Sale*', 'hustle' );
					} else {
