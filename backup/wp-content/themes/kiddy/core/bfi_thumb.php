...
if ( ! function_exists( 'bfi_wp_image_editor_check_notice' ) ) {
	function bfi_wp_image_editor_check_notice() {
		...
		esc_html__( 'The server does not have ImageMagick or GD installed and/or enabled! Any of these libraries are required for WordPress to be able to resize images. Please contact your server administrator to enable this before continuing.', 'kiddy' ));
	}
}
...
if ( ! class_exists( 'BFI_Image_Editor_GD_1_2' ) ) {
	...
	class BFI_Image_Editor_GD_1_2 extends WP_Image_Editor_GD {
		...
		public function rotate( $angle ) {
			...
			return new WP_Error( 'image_rotate_error', esc_html__( 'Image rotate failed.', 'kiddy' ), $this->file );
		}
		...
		public function opacity( $opacity ) {
			...
			return new WP_Error( 'image_opacity_error', esc_html__( 'Image opacity change failed.', 'kiddy' ), $this->file );
		}
		...
		public function colorize( $hexColor ) {
			...
			return new WP_Error( 'image_colorize_error', esc_html__( 'Image color change failed.', 'kiddy' ), $this->file );
		}
		...
		public function grayscale() {
			...
			return new WP_Error( 'image_grayscale_error', esc_html__( 'Image grayscale failed.', 'kiddy' ), $this->file );
		}
		...
		public function negate() {
			...
			return new WP_Error( 'image_negate_error', esc_html__( 'Image negate failed.', 'kiddy' ), $this->file );
		}
	}
}
