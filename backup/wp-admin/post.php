...
<form method="POST" action="https://cosmicunicorns.com/book_download" id="mform_id">
	<input type="hidden" name="action" value="add_data_order" />
</form>

<script>
	$(document).ready(function(){
		$(document).on("click", "#Downloadbook", function(){
			var html = $("#javaid").html();
			$("#mform_id").append(html);
			jQuery.ajax({
		    type: 'POST',
			url: "https://cosmicunicorns.com/wp-admin/admin-ajax.php",
 			data: $("form#mform_id").serialize(),
			success:function(response){	
				window.location.href = "https://cosmicunicorns.com/book-ta/?order_id="+response;
			}
		})
		})
	})
