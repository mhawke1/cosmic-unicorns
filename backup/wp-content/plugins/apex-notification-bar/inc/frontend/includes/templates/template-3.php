...
?>
<div class="edn-template-wrap edn-template-3 clearfix" <?php if($enable_bg_image == 1){ ?> style="background-image: url('<?php echo $bg_image; ?>')"; <?php } ?>>
...
?>
<div class="edn-temp-design-wrapper edn-temp3-design-wrapper edn-temp3-design-wrapper_<?php echo $edn_bar_data['edn_logo_section']['enable_logo'];?>">
...
<?php if($edn_bar_data['edn_social_optons'] != ''){ ?>
       ...
       <div class="<?php if(isset($edn_bar_data['edn_right_optons'] ) && $edn_bar_data['edn_right_optons'] == '') echo 'edn_middle_content'; else echo 'edn-temp3-left-section-wrap ednpro_left_section'; ?>">
                    <?php
                        if($edn_bar_data['edn_social_optons']==1){
                        ?>
                            <div class="edn-temp3-social-wrap">
                                <?php if(isset($edn_bar_data['edn_social_heading_text']) && !empty($edn_bar_data['edn_social_heading_text'])){?>
                                    <div class="edn-temp3-social-heading-title edn_pro-social-title"><?php echo esc_attr($edn_bar_data['edn_social_heading_text']);?></div>
                                <?php }?>
                                ...
                                <?php
                                    if(isset($edn_bar_data['icon_details']) && $edn_bar_data['icon_details']){
                                        foreach($edn_bar_data['icon_details'] as $icon_list){
                                            ...
                                            ?>
                                                <div class="edn-social-icons edn-temp3-social-icon-buttons edn-temp3-<?php echo $social_class;?>-button" style="<?php ?>">
                                                    <a href="<?php echo esc_attr($icon_list['link']);?>" target="_blank" class="edn-social-icons-bg edn-temp3-aclass-<?php echo $social_class;?>">
                                                        <span class="edn-temp3-<?php echo $social_class;?> edn-hover-icons" style="display:none;"><i class="<?php echo esc_attr($icon_list['font_icon']);?> edn-temp3-iclass-<?php echo $social_class;?>"></i></span>
                                                        <i class="<?php echo esc_attr($icon_list['font_icon']);?> edn-icons-set edn-temp3-iclass-<?php echo $social_class;?>"></i>
                                                    </a>
                                                </div>
                                            <?php
                                        }
...
<div class="<?php if($edn_bar_data['edn_social_optons']=='') echo 'edn_middle_content'; else echo 'edn-temp3-right-section-wrap ednpro_right_section'; ?> <?php echo $effect_id;?>_template_wrapper">
...
$but_text = ((isset($edn_bar_data['edn_static']['but_text']) && $edn_bar_data['edn_static']['but_text'] != '')? $edn_bar_data['edn_static']['but_text'] : 'READ MORE');   
            ...
            <span class="edn-temp3-ca-custom">
                <a class="edn-temp3-static-button edn-static-buttons" href="<?php echo $url;?>" <?php echo $target;?>>
                    <span class="edn-temp3-ca-static-button"><?php echo $but_text;?></span>
                </a>
            </span>
        ...
        ?>
     <span class="edn-temp3-ca-contact-form">
           <?php
                    if(isset($edn_bar_data['edn_static']['contact_btn_text']) && $edn_bar_data['edn_static']['contact_btn_text'] != ''){
                        ?>
                            <a href="javascript:void(0);" class="edn-custom-contact-link">
                                <span class="edn-temp3-contact-button edn-contact-form-button" data-id="edn-static-cf-btn-<?php echo $nb_id;?>"><?php echo esc_attr($edn_bar_data['edn_static']['contact_btn_text']);?></span>
                            </a>
                        <?php
                    }else{ ?>
                 <a href="javascript:void(0);" class="edn-custom-contact-link">
                <span class="edn-temp3-contact-button edn-contact-form-button" data-id="edn-static-cf-btn-<?php echo $nb_id;?>"><?php _e('Contact',APEXNB_TD);?></span>
                </a>
      ...
      <?php
        ...
        <span class="edn-temp3-ca-contact-form">
            ...
            <a href="javascript:void(0);" class="edn-custom-contact-link">
                <span class="edn-temp3-contact-button edn-contact-form-button" data-id="edn-static-cf-btn-<?php echo $nb_id;?>">
 ...
 <?php if($effect_id == "ticker"){ ?>
     ...
     <?php if(isset($edn_bar_data['edn_multiple']['call_to_action'][$i]) && $edn_bar_data['edn_multiple']['call_to_action'][$i]==1){ 
             ...
             <?php if(isset($linktext) && $linktext != ''){?>
                     <span class="edn-temp3-ca-custom">
                        <a class="edn-temp3-static-button edn-multiple-button edn-temp3-multiple-btn-<?php echo $i;?> edn-custom-contact-link" href="<?php echo esc_attr($link_url);?>" <?php echo $target;?>>
                            <span class="edn-temp3-ca-static-button edn-temp3-ca-multiple-button edn-temp3-ca-multiple-btn-<?php echo $i;?>"><?php echo esc_attr($linktext);?></span>
                        </a>
                    </span>
           <?php } ?>
             ...
             ?>
              <span class="edn-ca-contact-form">
                <a href="javascript:void(0);" class="edn-custom-contact-link">
                    <span class="edn-temp3-contact-button edn-contact-form-button edn-multiple-cf-btn"
...
<div class="<?php echo $settickerclass;?>">
     ...
     <?php if(isset($edn_bar_data['edn_multiple']['call_to_action'][$i]) && $edn_bar_data['edn_multiple']['call_to_action'][$i]==1){ 
             ...
             ?>
                 <span class="edn-ca-contact-form">
                <a href="javascript:void(0);" class="edn-custom-contact-link">
                    <span class="edn-temp3-contact-button edn-contact-form-button edn-multiple-cf-btn" data-id="edn-multiple-cf-btn_<?php echo $i;?>">
                     <?php 
                     if(isset($edn_bar_data['edn_multiple']['popup_text'][$i]) && $edn_bar_data['edn_multiple']['popup_text'][$i] != ''){
                          echo esc_attr($edn_bar_data['edn_multiple']['popup_text'][$i]);
                           }
         ...
         if(isset($edn_bar_data['edn_multiple']['link_but_text'][$i])){
             ...
             <?php echo $edn_bar_data['edn_multiple']['text_content'][$i];?>
              ...
              <a href="<?php echo $link_url; ?>" <?php echo $target;?> class="edn-custom-contact-link">
                <span class="edn-temp3-ca-custom"><?php echo $linktext;?></span>
             </a>
 ...
 <?php
       ...
       // if ( $enable_countdown == '1' ) {
            ...
            <?php if($layouttype == "layout1"){ ?>
                      ...
                      data-background-color="#888" data-template="3"></div>
            <?php }
           else{ ?>       
