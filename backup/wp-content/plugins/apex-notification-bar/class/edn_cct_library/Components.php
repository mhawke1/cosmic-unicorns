<?php
if ( !class_exists( 'EDN_CCObject' ) ) {
abstract class EDN_CCObject{
	/**
	...
	protected function validate(Array $params){
		try{
			foreach($params as $field){
				if(empty($this->$field)){
					throw new EDN_CTCTException("Constant Contact ".get_class($this)." Error: '".$field."' was required but not supplied");
				}
			}
...
if ( !class_exists( 'EDN_ContactList' ) ) {
class EDN_ContactList extends EDN_CCObject{
    public $contactCount;
...
if ( !class_exists( 'EDN_Contact' ) ) {
class EDN_Contact extends EDN_CCObject{
    public $link;
    public $id;
    public $updated;
    public $status;
...
if ( !class_exists( 'EDN_Campaign' ) ) {
class EDN_Campaign extends EDN_CCObject{
    public $name;
    public $id;
    public $link;
    public $status;
...
if ( !class_exists( 'EDN_Folder' ) ) {
class EDN_Folder extends EDN_CCObject{
    public $name;
    public $id;
    public $link;
...
if ( !class_exists( 'EDN_Image' ) ) {
class EDN_Image extends EDN_CCObject{
    public $name;
    public $id;
    public $link;
    public $updated;
...
if ( !class_exists( 'EDN_VerifiedAddress' ) ) {
class EDN_VerifiedAddress extends EDN_CCObject{
    public $email;
    public $status;
    public $verifiedTime;
    public $id;
...
if ( !class_exists( 'EDN_Registrant' ) ) {
class EDN_Registrant extends EDN_CCObject{
    public $title;
    public $link;
    public $id;
    public $updated;
...
if ( !class_exists( 'EDN_CustomField' ) ) {
class EDN_CustomField{
    public $question;
    public $answers;
...
if ( !class_exists( 'EDN_RegistrantInformation' ) ) {
class EDN_RegistrantInformation{
    public $label;
    public $addr1;
    public $addr2;
    public $addr3;
...
if ( !class_exists( 'EDN_PersonalInformation' ) ) {
class EDN_PersonalInformation extends EDN_RegistrantInformation{
    public $cellPhone;
...
if ( !class_exists( 'EDN_BusinessInformation' ) ) {
class EDN_BusinessInformation extends EDN_RegistrantInformation{
    public $fax;
    public $website;
    public $blog;
    public $company;
...
if ( !class_exists( 'EDN_EventLocation' ) ) {
class EDN_EventLocation{
    public $location;
    public $addr1;
    public $addr2;
    public $addr3;
...
if ( !class_exists( 'EDN_Event' ) ) {
class EDN_Event extends EDN_CCObject{
    public $title;
    public $link;
    public $updated;
    public $id;
...
if ( !class_exists( 'EDN_PaymentOption' ) ) {
class EDN_PaymentOption{}
}

if ( !class_exists( 'EDN_PayPalPayment' ) ) {
class EDN_PayPalPayment extends EDN_PaymentOption{
    public $type;
    public $payPalEmail;
...
if ( !class_exists( 'EDN_DoorPayment' ) ) {
class EDN_DoorPayment extends EDN_PaymentOption{
    public $type;
...
if ( !class_exists( 'EDN_CheckPayment' ) ) {
class EDN_CheckPayment extends EDN_PaymentOption{
    public $type;
    public $addr1;
    public $addr2;
    public $addr3;
...
if ( !class_exists( 'EDN_RegistrationType' ) ) {
class EDN_RegistrationType{
    public $name;
...
if ( !class_exists( 'EDN_CampaignEvent' ) ) {
class EDN_CampaignEvent{
    public $id;
    public $title;
    public $updated;
    public $contactId;
...
if ( !class_exists( 'EDN_Schedule' ) ) {
class EDN_Schedule extends EDN_CCObject{
    public $link;
    public $id;
    public $updated;
    public $time;
    ...
    public static function findUrl($item){
        $return = null;
         try{
            ...
            if($return == null){ throw new EDN_CTCTException('Constant Contact Error: Unable to determine which url to access');}
         } catch (EDN_CTCTException $e){
            $e->generateError();
         }
          return $return;
...
if ( !class_exists( 'EDN_CTCTException' ) ) {
class EDN_CTCTException extends Exception{
