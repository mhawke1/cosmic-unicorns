<script>
    ...
    (function($) {
        var prefetch_cache = [];
        var allowed_hosts = <?php echo json_encode($domains); ?>;
        var do_cleanup = !!$.cookie('<?php echo WPHYPERSPEED_SLUG; ?>_cleanup_address_bar');
        ...
        function get_cookie(){
            var c = $.cookie('<?php echo WPHYPERSPEED_SLUG; ?>');
            if(c){
                return c;
            }
            return false;
        ...
        function prefetch(element, only_update_links) {
            ...
            var search = element.search.replace(/<?php echo WPHYPERSPEED_SLUG; ?>=[0-9]+&?/, '');

            //add our 'new' query...
            search += (search.length > 1 ? '&' : '') + '<?php echo WPHYPERSPEED_SLUG; ?>=' + get_cookie();
        ...
        function refresh_cookie(){
            if(!$.cookie('<?php echo WPHYPERSPEED_SLUG; ?>_refresh')){
