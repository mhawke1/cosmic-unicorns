...
if( ! class_exists('Metatick_WP_Licensing_1_4') ){
	class Metatick_WP_Licensing_1_4{
		...
		public function __construct($product,$secret,$name,$per_site_licensing = false, $no_alert = false){
			...
			if ( ! wp_next_scheduled( 'Metatick_WP_Licensing_1_4_do_check' ) ) {
				wp_schedule_event( time(), 'daily', 'Metatick_WP_Licensing_1_4_do_check' );
			}
			add_action( 'Metatick_WP_Licensing_1_4_do_check', array($this,'update'));
		}
