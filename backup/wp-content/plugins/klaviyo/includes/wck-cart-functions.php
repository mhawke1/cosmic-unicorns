...
if (
    ...
    add_filter( 'woocommerce_checkout_fields', 'kl_sms_consent_checkout_field' );
...
//TODO: Update this to check Email checkbox as well (like SMS logic above)
if ( !empty( $klaviyo_settings['klaviyo_newsletter_list_id'] ) ) {
    // Add the checkbox field
    add_filter( 'woocommerce_checkout_fields', 'kl_checkbox_custom_checkout_field' );
