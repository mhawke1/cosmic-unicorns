...
class WP_CWS_Demo_Import extends WP_Importer {
	...
	function greet() {
		...
		*/
		...
		if (empty($pc)) {
			echo '<b><font color=red>Warning!</font></b> Please insert your <a href="https://help.market.envato.com/hc/en-us/articles/202822600-Where-Is-My-Purchase-Code-" target="_blank">Item Purchase Code</a> with the help of <a href="admin.php?page=cwsfw&section=help_options">Theme Options</a> panel or install and activate your <a href="plugin-install.php?tab=search&s=envato-elements">Envato Elements</a> plugin, if you got this theme from Envato Elements, to proceed with the demo import.';
			echo '</div>';
			return;
		} else {
