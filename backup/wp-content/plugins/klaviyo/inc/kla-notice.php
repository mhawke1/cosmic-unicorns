    ...
    function admin_message( $message='default_error', $display_time=0 ) {
        ...
        switch ($message) {
            ...
            case 'same_list_ids':
                ...
                break;
            //TODO: Update message text to reflect using checkbox and List ID, remove sunset text
            case 'use_checkbox':
                $message_text = 'Please use the `Subscribe contacts to Email Marketing` checkbox setting, we will be sunsetting using the Email List ID to determine checkbox visibility at checkout on 15th May, 2021';
                break;
            default:
        ...
        if( in_array( $message, array( 'same_list_ids', 'add_sms_list_id', 'use_checkbox' ) ) ) {
